...
import { LoadExpensesDatataComponent } from './components/expenses-context/items/load-expenses-datata/load-expenses-datata.component';
...
const routes: Routes = [
  ...
  {path:'process', component: DashboardContextComponent, children:[
    ...
    {path:'expenses', component: ExpensesContextComponent, children:[
      ...
      {path:'list', component: LoadExpensesDatataComponent}
    ]}, 
